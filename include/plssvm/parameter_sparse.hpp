...
class parameter_sparse {
  ...
  public:
     ...
     */
    virtual ~parameter_sparse() = default;
    ...
    std::shared_ptr<const plssvm::openmp::csr<real_type>> data_ptr{};
    ...
    std::shared_ptr<const plssvm::openmp::csr<real_type>> test_data_ptr{}; //NEEDS FURTHER CHECKING----------------------------
...
extern template class parameter_sparse<float>;
extern template class parameter_sparse<double>;
