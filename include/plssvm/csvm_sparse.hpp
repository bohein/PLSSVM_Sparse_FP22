...
class csvm_sparse {
  ...
  protected:
    ...
    const std::shared_ptr<const plssvm::openmp::csr<real_type>> data_ptr_{};
...
extern template class csvm_sparse<float>;
extern template class csvm_sparse<double>;
