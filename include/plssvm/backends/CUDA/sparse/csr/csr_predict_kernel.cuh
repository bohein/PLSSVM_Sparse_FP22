 ...
 * @param[in] height the number of data-points in the data matrix
 ...
 */
template <typename real_type>
__global__ void device_kernel_predict_radial(real_type *out_d, const size_t *col_ids, const size_t *row_ids, const real_type *values, const kernel_index_type nnz, const kernel_index_type height, const real_type *alpha_d, const size_t *predict_col_ids, const size_t *predict_row_ids, const real_type *predict_values, const kernel_index_type predict_nnz, const kernel_index_type predict_height, const real_type gamma);
