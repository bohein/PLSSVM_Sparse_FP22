 ...
 */
template <typename real_type>
void device_kernel_q_poly(std::vector<real_type> &q, const coo<real_type> &data, int degree, real_type gamma, real_type coef0);
 ...
 */
template <typename real_type>
void device_kernel_q_poly(std::vector<real_type> &q, const csr<real_type> &data, int degree, real_type gamma, real_type coef0);
 ...
 */
template <typename real_type>
void device_kernel_q_radial(std::vector<real_type> &q, const coo<real_type> &data, real_type gamma);
 ...
 */
template <typename real_type>
void device_kernel_q_radial(std::vector<real_type> &q, const csr<real_type> &data, real_type gamma);
