...
#include "plssvm/benchmarks/CUDA/benchmark_svm_kernel_cuda.cuh" // plssvm::benchmarks::benchmark_svm_kernel_cuda
...
int main(int argc, char *argv[]) {
    ...
    benchmarks.push_back(new benchmark_svm_kernel_cuda);
