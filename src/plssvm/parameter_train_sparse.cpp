...
#include "plssvm/parameter_train_sparse.hpp"
...
template <typename T>
parameter_train_sparse<T>::parameter_train_sparse(std::string p_input_filename) {
...
template <typename T>
parameter_train_sparse<T>::parameter_train_sparse(int argc, char **argv) {
...
template class parameter_train_sparse<float>;
template class parameter_train_sparse<double>;
